...
***** Rule
      ...
      #+BEGIN_QUOTE
      where a man contracts to deliver any article besides money, and fails to do it, the rule of damages is the value of the article at the time and place of delivery, and the interest for the delay.
      #+END_QUOTE

      #+BEGIN_QUOTE
      the actual damages suffered by a party cannot always be the rule of estimating damages for a breach of K.
      #+END_QUOTE
